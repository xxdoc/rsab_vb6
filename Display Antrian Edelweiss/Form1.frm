...
Dim ratus As Boolean
    ...
    If jenis = "F" Then Call sndPlaySound(App.Path & "\sound\FF.wav", SND_ALIAS Or SND_SYNC)
    If jenis = "G" Then Call sndPlaySound(App.Path & "\sound\GG.wav", SND_ALIAS Or SND_SYNC)
