...
bolStrukResep = True
        ...
        With ReportResep
            ...
            strSQL = "select so.tglorder, so.noorder, jp.name,ru2.namaruangan as ruangantujuan, " & _
                    "ru.namaruangan as ruangan, pg.namalengkap, " & _
                    "pr.id as idproduk, pr.namaproduk, ss.satuanstandar, op.qtyproduk, so.totalhargasatuan as hargasatuan, (so.totalhargasatuan * op.qtyproduk) as total, so.keteranganorder " & _
