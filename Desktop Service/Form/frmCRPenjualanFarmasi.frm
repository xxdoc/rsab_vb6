...
'            " order by tglresep"
    ...
    strSQL = "select sr.tglresep,sr.noresep,pd.noregistrasi,upper(ps.namapasien) as namapasien,case when jk.jeniskelamin = 'laki-laki' then 'l' else 'p' end as jeniskelamin, " & _
