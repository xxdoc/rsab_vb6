...
Set Report = New crCetakRekapLayananDokter
    ...
    Format(tglAkhir, "yyyy-MM-dd 23:59:59") & "'" ' and djp.objectjenisprodukfk <> 97 and kp.id in (1,2,3,4,8,9,10,11,13,14,26) and sp.statusenabled is null "
'    strFilter = strFilter & " and IdRuangan like '%" & strIdRuangan & "%' and IdDepartement like '%" & strIdDepartement & "%' and IdKelompokPasien like '%" & strIdKelompokPasien & "%' and IdDokter Like '%" & strIdDokter & "%'"
    ...
    If strIdDepartemen <> "" Then
        ...
        Else
            If strIdDepartemen <> "" Then
                strFilter = strFilter & " AND ru2.objectdepartemenfk <> 16 "
            End If
        End If
    End If
    ...
    strSQL = "select DISTINCT pp.tglpelayanan, apd.objectruanganfk, upper(ru.namaruangan) as namaruangan,pg.namalengkap,pd.noregistrasi,ps.nocm ,  " & _
            ...
            "left JOIN strukbuktipenerimaan_t as sbm  on sbm.norec=sp.nosbmlastfk " & orderby
