...
Begin VB.Form frmCRCetakKIP 
   Caption         =   "Medifirst2000"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakKIP.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCRCetakKIP"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crJenisKIP
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCRCetakKIP = Nothing
End Sub

Public Sub CetakKIP(strNoregistrasi As String, jumlahCetak As Integer, strIdPegawai As String, STD As String, view As String)
...
Dim strKet As Boolean
    ...
    Set frmCRCetakKIP = Nothing
    Set Report = New crJenisKIP
    
    ReadRs "select pd.noregistrasi,ps.nocm,ps.namapasien,ps.objectjeniskelaminfk,ru.namaruangan,kp.kelompokpasien " & _
    ...
    With Report
        If Not RS.EOF Then
            .txtNoBKM.SetText RS("noregistrasi") & "/" & RS!nocm
