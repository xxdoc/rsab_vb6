...
Begin VB.Form frmCrRekapHarianPemeriksaan 
   ...
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCrRekapHarianPemeriksaanRehab.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
...
Option Explicit
Dim Report As New crRekapHarianPemeriksaanRehab
...
Public Sub cetak(idKasir As String, tglAwal As String, tglAkhir As String, idRuangan As String, namaKasir As String, view As String)
'On Error GoTo errLoad
'On Error Resume Next

Set frmCrRekapHarianPemeriksaanRehab = Nothing
...
Set Report = New crRekapHarianPemeriksaanRehab
    strSQL = "SELECT " & _
                " produk_m.id, " & _
